...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--update_method', type=int, default=1, help='update method')
        self.parser.add_argument('--sample_method', type=str, default='seq', help='sampling method')
        self.parser.add_argument('--delta', type=float, default=0.05, help='delta')
        self.parser.add_argument('--ratio', type=float, default=0.04, help='ratio')
